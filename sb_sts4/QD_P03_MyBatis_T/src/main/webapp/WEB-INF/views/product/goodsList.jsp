		...
		<main id="main">
			...
			<c:forEach var="listData" items="${listData }">
				...
				<div class="colWidth dFlex dataRow">
					<span>
						<input type="checkbox" form="delForm" class="chkRem" name="chkRem" value="${listData.num }">
					</span>
			...
			<div id="listFuncArea" class="dFlex">
				<button type="button" form="delForm" id="delBtn">선택삭제</button>
...
<!-- 		<form action="/search" id="srchForm"></form> -->
