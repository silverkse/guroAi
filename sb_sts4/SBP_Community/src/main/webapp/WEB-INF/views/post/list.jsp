			...
			<ul class="pagination justify-content-center">
				...
				<c:choose>
					<c:when test="${postList.first }">
						<li class="page-item disabled">
							<a class="page-link" href="?page=0">Prev(이전)</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="page-item">
							<a class="page-link" href="?page=${postList.number-1 }">Prev(이전)</a>
						</li>
					</c:otherwise>
				</c:choose>
				...
				<c:choose>
					<c:when test="${postList.last }">
						<li class="page-item disabled">
						<a href="?page=${postList.totalPages-1 }" class="page-link">Next(다음)</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="page-item">
							<a class="page-link" href="?page=${postList.number+1 }">Next(다음)</a>
						</li>
					</c:otherwise>
				</c:choose>
