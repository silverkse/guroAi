...
// out.print(objToday + "<br>");
// out.print(objToday.getYear() + "<br>");
// out.print(objToday.getMonthValue() + "<br>");
// out.print(objToday.getDayOfMonth() + "<br>");
...
<body>
	<div id="wrap" class="resWrap">
		...
		<div class="datePrnArea">
			<span>Today</span>
			<input type="text" value="<%=openYear %>" id="yearToday" class="yearPrn">
			<span>년</span>
			<input type="text" value="<%=openMonth %>" id="monthToday" class="monthPrn">
			<span>월</span>
			<input type="text" value="<%=openDate %>" id="dateToday" class="datePrn">
			<span>일</span>
		</div>
		<div class="datePrnArea">
			<span>Open</span>
			<input type="text" value="<%=todayYear %>" id="yearOpen" class="yearPrn">
			<span>년</span>
			<input type="text" value="<%=todayMonth %>" id="monthOpen" class="monthPrn">
			<span>월</span>
			<input type="text" value="<%=todayDate %>" id="dateOpen" class="datePrn">
			<span>일</span>
		</div>
